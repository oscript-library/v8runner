...
Процедура ТестДолжен_ПроверитьСозданиеФайловПоставки() Экспорт
	...
	юТест.ПроверитьИстину(ФайлСуществует(ПутьФайлПолнойПоставки), "Файл полной поставки конфигурации должен существовать");
	юТест.ПроверитьИстину(ФайлСуществует(ПутьФайлаПоставкиОбноления), "Файл частичной поставки конфигурации должен существовать");
