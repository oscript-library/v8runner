...
Процедура ТестДолжен_ОставитьФайлИнформации() Экспорт
	...
	Утверждения.ПроверитьИстину(текстВФайле = текстВывода, "Вывод и текст файла должны совпадать");
	...
	текстКоторыйУжеЛежитВФайле = "Текст который уже лежит в файле. Он очень важен! Не удаляйте его, пожалуйста";
	...
	Утверждения.ПроверитьИстину( Не текстВФайле = текстВывода, "Текст в файле вывода и в выводе должны отличаться");
