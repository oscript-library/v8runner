...
//   ТолькоФайлВерсий    - Булево - Выгружает файл версий ConfigDumpInfo.xml
//
...
Процедура ВыгрузитьКонфигурациюВФайлы(Знач КаталогВыгрузки, 
                                      ...
                                      Знач ПутьКСпискуОбъектовВыгрузки = "",
									  Знач ТолькоФайлВерсий = Ложь) Экспорт
	...
	Если ИспользуемаяВерсияПлатформыСтаршеИлиРавна("8.3.10") Тогда
		...
		ИначеЕсли ТолькоФайлВерсий Тогда
