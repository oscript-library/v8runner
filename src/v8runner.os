...
// Выгружает файл поставки конфигурации
//
// Параметры:
//   ФайлКонфигурации - Строка - путь к файлу конфигурации
//
Процедура ВыгрузитьФайлПоставкиКонфигурации(Знач ФайлКонфигурации) Экспорт
	
	Параметры = СтандартныеПараметрыЗапускаКонфигуратора();
	Параметры.Добавить("/CreateDistributionFiles -cffile """ + ФайлКонфигурации + """");
	ВыполнитьКоманду(Параметры);
