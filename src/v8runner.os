...
//   Формат - РежимВыгрузкиКонфигурации - Формат выгрузки. По умолчанию используется "иерархический"
//
Процедура ВыгрузитьВнешниеОтчетыИлиОбработкиВФайлы(Знач ПутьККаталогуВыгрузки, 
	...
	КаталогВнешнейОбработкиИлиОтчета = Файл.ПолноеИмя;
	...
	ПараметрыЗапуска.Добавить(ОбернутьВКавычки(КаталогВнешнейОбработкиИлиОтчета));
