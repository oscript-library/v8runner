...
// 
//Параметры:
//   СтрокаСоединения - Строка - имя cf-файла с объединяемой конфигурацией.
//   ПользовательХранилища - строка - имя файла с настройками объединения конфигураций.
//   ПарольХранилища - Строка - флаг необходимости установки конфигурации на поддержку.
...
//   ПарольХранилищаКопииd - Строка - Пароль пользователя хранилища, из которого выполняется копирование пользователей.
...
Процедура КопироватьПользователейИзХранилища(Знач СтрокаСоединения, 
    ...
    Параметры.Добавить(СтрШаблон("-Path ""%1""",СтрокаСоеденияХранилищаКопии));
