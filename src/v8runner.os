...
Процедура ЗагрузитьКонфигурациюИзФайлов(Знач КаталогЗагрузки, 
	...
	Если ИспользуемаяВерсияПлатформыСтаршеИлиРавна("8.3.10") Тогда
		...
		Если ЗначениеЗаполнено(ПутьКСпискуФайловЗагрузки) Тогда
			...
			ОбработатьСписокФайловЗагрузки(ПутьКСпискуФайловЗагрузки, ПутьКСпискуФайловЗагрузки_Обработанный);
...
//
Процедура ОбработатьСписокФайловЗагрузки(ПутьКСпискуФайловЗагрузки, ПутьКСпискуФайловЗагрузки_Обработанный) Экспорт
	Кодировка = "UTF-8";
