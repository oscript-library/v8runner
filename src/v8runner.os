...
//
Процедура ЗахватьОбъектыВХранилище(Знач СтрокаСоединения, 
    								Знач ПользовательХранилища,
                                    Знач ПарольХранилища = "",
...
Процедура ПоместитьИзмененияОбъектовВХранилище(Знач СтрокаСоединения, 
	...
	МассивСтрок = СтрРазделить(Комментарий, Символы.CR);
...
//
Процедура ПодключитьсяКХранилищю(Знач СтрокаСоединения, 
    								Знач ПользовательХранилища,
                                    Знач ПарольХранилища = "",
