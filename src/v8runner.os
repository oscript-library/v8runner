...
Процедура ПолучитьИзмененияКонфигурацииБазыДанныхИзХранилища(Знач СтрокаСоединения, Знач ПользовательХранилища, Знач ПарольХранилища="", Знач НомерВерсииХранилища = "") Экспорт
	...
	Если НЕ ПустаяСтрока(НомерВерсииХранилища) Тогда
...
Процедура ОбновитьКонфигурациюБазыДанныхИзХранилища(СтрокаСоединения, ПользовательХранилища, ПарольХранилища="", Знач НомерВерсииХранилища = "") Экспорт
